...
const SEED_FIRST_CLAIM_DURATION_IN_SECONDS = END_CLIFF_TIME.sub(SEED_START); // 1599854400 - 1597287600  = 2566800
...
const PRIVATE_FIRST_CLAIM_DURATION_IN_SECONDS = END_CLIFF_TIME.sub(PRIVATE_START); // 1599854400 - 1597287600  = 2566800
...
const STRATEGIC_FIRST_CLAIM_DURATION_IN_SECONDS = END_CLIFF_TIME.sub(STRATEGIC_START); // 1599854400 - 1597287600  = 2566800
...
// 3.3.4 marketingTON
const MARKETING_START = END_CLIFF_TIME; // 2020. 9. 12 오전 5:00:00(KST)
