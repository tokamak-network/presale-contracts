...
contract Private2sale is WhitelistCrowdsale, IndividuallyCappedCrowdsale, IndividuallyPricedCrowdsale {
    ...
    function _preValidatePurchase(address beneficiary, uint256 weiAmount) internal view {
        ...
        require(amount == smallPayment || amount == getCap(beneficiary), "Strategysale: wei amount should be equal to purchaser cap or equal to 0.03 ether");
